...
[ -n "$PEXELS_API_KEY" ]      && store_secret "PEXELS_API_KEY"      "$PEXELS_API_KEY"
[ -n "$PAPPERS_API_KEY" ]     && store_secret "PAPPERS_API_KEY"     "$PAPPERS_API_KEY"
[ -n "$PERPLEXITY_API_KEY" ]  && store_secret "PERPLEXITY_API_KEY"  "$PERPLEXITY_API_KEY"
...
[ -n "$PEXELS_API_KEY" ]     && ENV_VARS="${ENV_VARS},PEXELS_API_KEY=${PEXELS_API_KEY}"
[ -n "$PAPPERS_API_KEY" ]    && ENV_VARS="${ENV_VARS},PAPPERS_API_KEY=${PAPPERS_API_KEY}"
[ -n "$PERPLEXITY_API_KEY" ] && ENV_VARS="${ENV_VARS},PERPLEXITY_API_KEY=${PERPLEXITY_API_KEY}"
[ -n "$PERPLEXITY_MODEL" ]   && ENV_VARS="${ENV_VARS},PERPLEXITY_MODEL=${PERPLEXITY_MODEL}"
[ -n "$MONITOR_TZ" ]         && ENV_VARS="${ENV_VARS},MONITOR_TZ=${MONITOR_TZ}"
